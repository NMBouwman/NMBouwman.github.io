...
<p style="text-align: center;">
<img title="XOR table of the Braille alphabet." alt="A large table that shows the result of XORing each letter in the alphabet with every other letter in the alphabet. The majority of elements in the table are empty. The columns and rows corresponding to the letters I, J, S and T show many results. This indicates that every letter in the first two decades form a triplet with these four letters. The bottom right corner of the table contains some more scattered letters, corresponding to triplets formed with the letters U through Z." src="/images/braille_binary_triplet_table.svg" width="700"></p>
